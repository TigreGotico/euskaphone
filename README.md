...
| gold | kind | figure |
|------|------|--------|
| orthography2ipa eu gold (160 rows, 8 lects) | **regression fixture** (same lattice made it) | PER `0.0000` — proves the lattice is untouched, *not* accuracy |
| [WikiPron](https://github.com/CUNY-CL/wikipron) `eus_latn` broad | independent word gold | PER `≈0.10`, word-acc `≈0.32` (3k-word sample) |
| [HiTZ/EHU](https://huggingface.co/datasets/HiTZ/wikipedia_basque_ipa) Wikipedia G2P | independent cross-engine (Univ. of the Basque Country) | PER `≈0.14` folded (2k-sentence sample) |
